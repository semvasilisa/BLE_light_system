...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x20000270, (ISR)0x17f85}, /* 13 */
	...
	{(const void *)0xe56d, (ISR)0x18149}, /* 42 */
