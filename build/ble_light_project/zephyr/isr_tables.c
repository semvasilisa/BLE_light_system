...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x20000244, (ISR)0x13bd1}, /* 13 */
	...
	{(const void *)0xb781, (ISR)0x13d95}, /* 42 */
