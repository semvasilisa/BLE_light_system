...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x200001f4, (ISR)0x1736f}, /* 13 */
	...
	{(const void *)0xd989, (ISR)0x174d5}, /* 42 */
